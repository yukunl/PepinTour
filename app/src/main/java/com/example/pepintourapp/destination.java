...
public class destination {
    ...
    private String Name, ImageURL, txt, hours, address, contact;
...
//            "714f", "816f", "315e", "806t", "504s", "207l", "410s", "402s", "410t", "404m"));
    ...
    public destination(String name, String imageURL, String description, String hr, String addr, String contac){
        Name = name;
        ImageURL = imageURL;
        txt = description;
        hours = hr;
